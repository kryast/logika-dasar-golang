...
func main() {
	...
	*/
	...
	for i := 1; i <= kotak; i++ {
		// Loop kedua untuk mengiterasi setiap kolom dari 1 hingga 'kotak - 1'
		for j := 1; j < kotak; j++ {
			// Memeriksa apakah kita berada di baris pertama, baris terakhir, kolom pertama, atau diagonal
			if i == 1 || i == kotak || j == 1 || j == i {
